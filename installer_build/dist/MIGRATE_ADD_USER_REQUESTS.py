...
def migrate_database(db_path=None):
    ...
    if db_path is None:
        ...
        server_db = r"C:\Program Files\TASMA Board Room Booking System\bookings.db"
        if os.path.exists(server_db):
            db_path = server_db
        else:
            # Try network path
            db_path = r"\\GVBSERVER\C$\Program Files\TASMA Board Room Booking System\bookings.db"
